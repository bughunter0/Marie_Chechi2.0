...
- /anti <on/off>: when someone tries to send a @BlueTextBot message, I will try to delete that!
"""

__mod_name__ = "anticommand"

DEL_REM_COMMANDS = CommandHandler("anti", rem_cmds, pass_args=True, filters=Filters.group)
